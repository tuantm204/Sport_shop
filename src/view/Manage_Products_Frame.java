...
public class Manage_Products_Frame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_productId = new javax.swing.JLabel();
        ...
        txt_productId.setText("Product Id");
        ...
        txt_category.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "  \t", "Áo ", "Quần ", "Giày", "Vật dụng thể thao" }));
    ...
    private void btn_createProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_createProductActionPerformed
        ...
        String category = txt_category.getSelectedItem().toString().trim();
    ...
    private void table_showProductMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_showProductMouseClicked
        ...
        if (selectedRow != -1) {
            String productId = table_showProduct.getValueAt(selectedRow, 0).toString();
            txt_productId.setText("Product Id: "+productId);
            ...
            txt_category.setSelectedItem(table_showProduct.getValueAt(selectedRow, 5).toString());
    ...
    private javax.swing.JLabel txt_productId;
